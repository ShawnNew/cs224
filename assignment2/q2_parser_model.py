...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.label_placeholder = tf.placeholder(dtype=tf.float32, shape=(None, self.config.n_classes))
        self.droupout_placeholder = tf.placeholder(dtype=tf.float32, shape=())
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        h_drop = tf.nn.dropout(h, 1-self.droupout_placeholder)
    ...
    def add_loss_op(self, pred):
        ...
        softmax_cross_entropy_loss = \
                tf.nn.softmax_cross_entropy_with_logits(labels=self.label_placeholder\
                , logits=pred)
        loss = tf.reduce_mean(softmax_cross_entropy_loss)
        ### END YOUR CODE
        return loss
